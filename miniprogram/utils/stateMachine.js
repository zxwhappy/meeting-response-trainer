...
const ALLOWED = Object.freeze({
  ...
  [STATES.LISTEN]: [STATES.PREP_FIRST, STATES.ERROR],
  [STATES.PREP_FIRST]: [STATES.LISTEN, STATES.RECORD_FIRST, STATES.ERROR],
  [STATES.RECORD_FIRST]: [STATES.ANALYZING_FIRST, STATES.ERROR],
  [STATES.ANALYZING_FIRST]: [STATES.FEEDBACK_FIRST, STATES.ERROR],
  [STATES.FEEDBACK_FIRST]: [STATES.RECORD_FIRST, STATES.RECORD_SECOND, STATES.ERROR],
  [STATES.RECORD_SECOND]: [STATES.ANALYZING_SECOND, STATES.ERROR],
  [STATES.ANALYZING_SECOND]: [STATES.RECORD_SECOND, STATES.COMPARISON, STATES.ERROR],
